<%@ Page Title="電話番号を確認する" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="VerifyPhoneNumber.aspx.cs" Inherits="掛率確認システム.Account.VerifyPhoneNumber" %>
